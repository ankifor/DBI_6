...
public:
	...
	shared_ptr<Block_Storage<Entry, 1024*400>> _storage;
...
public:
	...
	My_Hash(shared_ptr<Block_Storage<Entry, 1024*400> > storage)
		: _storage(storage)
		,_log2_n_buckets(_min_log2_n_buckets)
		,_size(0)
	{
		if (_storage == nullptr) {
			_storage = shared_ptr<Block_Storage<Entry, 1024*400>>(new Block_Storage<Entry, 1024*400>);
		}
